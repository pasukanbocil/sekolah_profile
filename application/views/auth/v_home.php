...
<div class="home">
    <div class="home_slider_container">
        ...
        <div class="owl-carousel owl-theme home_slider">
            ...
            <!-- Home Slider Item -->
            <div class="owl-item">
                <div class="home_slider_background" style="background-image:url(<?= base_url() ?>template/front-end/images/10.jpg)"></div>
                <div class="home_slider_content">
                    <div class="container">
                        <div class="row">
                            <div class="col text-center">
                                <div class="home_slider_title text-white">The Premium System Education</div>
            ...
            <!-- Home Slider Item -->
            <div class="owl-item">
                <div class="home_slider_background" style="background-image:url(<?= base_url() ?>template/front-end/images/9.png)"></div>
                <div class="home_slider_content">
                    <div class="container">
                        <div class="row">
                            <div class="col text-center">
            ...
            <!-- Home Slider Item -->
            <div class="owl-item">
                <div class="home_slider_background" style="background-image:url(<?= base_url() ?>template/front-end/images/3.png)"></div>
                <div class="home_slider_content">
                    <div class="container">
                        <div class="row">
                            <div class="col text-center">
